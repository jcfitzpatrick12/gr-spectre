...
#include "synced_sweep_driver_impl.h"
...
{
    return gnuradio::make_block_sptr<synced_sweep_driver_impl>(
...
float synced_sweep_driver_impl::compute_freq0() {
    return (_min_freq + _samp_rate/2);
}

void synced_sweep_driver_impl::publish_current_freq() {
...
int synced_sweep_driver_impl::work(int noutput_items,
