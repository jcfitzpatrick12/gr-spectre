...
#ifndef INCLUDED_SPECTRE_BATCHED_FILE_VECTOR_SINK_IMPL_H
#define INCLUDED_SPECTRE_BATCHED_FILE_VECTOR_SINK_IMPL_H
...
class batched_file_vector_sink_impl : public batched_file_vector_sink
{
private:
    ...
    int _vlen; /**< The length of the incoming vectors.*/
...
#endif /* INCLUDED_SPECTRE_BATCHED_FILE_VECTOR_SINK_IMPL_H */
